<?php 
	include ('../controller/dsachdt_conn.php');
	include ('header.php');
?>
				...
				<div class="product-list row">
					<?php while($record = mysqli_fetch_array($response)) { ?>
						<div class="product-item col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
							<p><a href="detailsdt.php?id_sp=<?php echo $record['id_sp']; ?>">
								<img class="thumbnail img-thumbnail" width="150px" src="../images_dt/<?php echo $record['anh_sp']; ?>">	
							</a></p>
							<a href="detailsdt.php?id_sp=<?php echo $record['id_sp']; ?>"><?php echo $record['ten_sp']; ?></a>
